...
@NamedStoredProcedureQuery(
        ...
        procedureName = "usp_get_all_books_by_author",
        parameters = {
        ...
        /**
         * DELIMITER ##
         * CREATE PROCEDURE usp_get_all_books_by_author(IN full_name VARCHAR(20), OUT count_out INT)
         * BEGIN
...
public class Book extends BaseEntity {
    ...
    public String findTitleAndPriceFormat() {
        return this.title + " - $" + this.price;
    }

    public String findTitleTypeAndPriceFormat() {
        return this.title + " " + this.getEditionType().name() + " " + this.price;
    }

    public String findTitleAndAuthorsNameFormat() {
        return this.title + " (" + this.author.findFirstNameAndLastNameFormat() + ")";
    }
}
