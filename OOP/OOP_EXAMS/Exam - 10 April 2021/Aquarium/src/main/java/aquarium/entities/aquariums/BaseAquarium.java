...
public abstract class BaseAquarium implements Aquarium {
    ...
    public String getInfo() {
        ...
        if (this.fish.isEmpty()) {
            ...
            fishOrNone = String.join(" ",fishNames);
        }

        info.append(String.format("Fish: %s",fishOrNone)).append(System.lineSeparator());
        info.append(String.format("Decorations: %d",this.decorations.size())).append(System.lineSeparator());
        info.append(String.format("Comfort: %d",this.calculateComfort())).append(System.lineSeparator());
